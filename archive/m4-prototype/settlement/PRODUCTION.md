...
- **Trait boundary**: `RecipientControlVerifier` trait opaque, `Box<dyn RecipientControlVerifier>` must work — verified for `Ed25519RegistryControlVerifier`, `SimulatedOrchardIvkControlVerifier`, `HybridControlVerifier`, `SettlementUnconfiguredControlVerifier`
